...
void doTest2(){
    ...
    StudentStruct ana("Ana", 1051, 88, 65);
    StudentStruct suji("Suji", 1052, 90, 93);
    StudentStruct zhang("Zhang", 1053, 100, 40);
    addStudent(students, &numOfStudent, ana.name.c_str(), ana.id, ana.record.midterm, ana.record.final);
    addStudent(students, &numOfStudent, suji.name.c_str(), suji.id, suji.record.midterm, suji.record.final);
    addStudent(students, &numOfStudent, zhang.name.c_str(), zhang.id, zhang.record.midterm, zhang.record.final);
